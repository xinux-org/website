...
Опубликовано ${new Date(release.published_at).toLocaleDateString("ru")}.\n\n${body}`}).join('\n\n')
  }</Markdown>
}

# Журнал изменений

Пожалуйста, посетите [страницу релизов Xinux](https://github.com/uzinfocom-org/xinux/releases), чтобы увидеть всю историю релизов.

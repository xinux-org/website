    ...
    <div className="content-container">
      <Features>
        ...
        <Feature index={9} href="/docs/guide/ssg">
          <h3>Dasturchilar uchun, <br/>ko'plab dasturlar.</h3>
          <p className='mr-6'>Dasturchilar uchun tayyor yordamchi qisqartmalar yaratishga kirishdik.</p>
        </Feature>
        <Feature index={10} large>
          <h3>Va yanada ko'proq...</h3>
          <p>Har doim ta'kidlaganimizday, Xinux bu bir yagona obraz emas,<br/>bir necha obrazlar tashkil topgan oiladir.</p>

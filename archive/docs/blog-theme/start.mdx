...
<Tabs items={["pnpm", "npm", "yarn"]}>
  <Tab>```bash pnpm i next react react-dom nextra nextra-theme-blog ```</Tab>
  <Tab>```bash npm i next react react-dom nextra nextra-theme-blog ```</Tab>
  <Tab>```bash yarn add next react react-dom nextra nextra-theme-blog ```</Tab>
</Tabs>
